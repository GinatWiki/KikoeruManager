...
function hydrateConfig(data = {}) {
  const next = {
    ...
    ai_title_translation: { ...defaultConfig.ai_title_translation, ...(data?.ai_title_translation || {}) },
...
function serializeConfig(config) {
  ...
  const serialized = {
    ...
    ai_title_translation: payload.ai_title_translation,
