...
const sectionKeyMap = {
  ...
  services: ['kikoeru_server', 'kikoeru_db', 'asmr_sync', 'rj_subtitle', 'email_watcher', 'bonus_probe', 'circle_external_search'],
...
const sections = [
  ...
  { id: 'services', title: '外部服务', short: 'Kikoeru、ASMR、RJ 字幕、特典补全', icon: ScanSearch, keywords: ['kikoeru', 'kikoeru_db', 'asmr', 'subtitle', 'email', 'bonus', 'probe', 'dlsite', '外部服务', '特典补全', '特典探测', '数据库'] },
